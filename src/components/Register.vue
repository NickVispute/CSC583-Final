<template>
    <section class="bg-light">
        ...
        <div style="float:left;">
            <img src="../assets/img1.png" style="height:400px;width:400px;">
        </div>
        <div id="contact-form" class="contact-form" style="float:right;margin-right: 65px;">
            <label class="col-lg-12"><b>Please enter Your details to join us</b></label>
            <br/>
            <br/>
         <form class="form col-md-12" @submit="onSubmit">
             ...
             <span v-if="user.escortRequired">
                 <label class="col-lg-3">Escort Name : </label>
        ...
        <div v-if="isAdmin">
            <p><b>Click <a href="/AdminView" target="_blank"><u>here</u></a> to see the details of all registered user</b></p>
        </div>
    </section>
</template>
